...
export type UsageSettingsCopy = {
  staleTitle: string; staleBody: string; loadFailed: string; capacityBody: string; previousResult: string; loadMore: string;
...
const SETTINGS_USAGE_COPY = {
  'zh-CN': {
    staleTitle: "统计已更新", staleBody: "当前显示的是之前的完整结果。请刷新后继续浏览。", loadFailed: "无法加载使用统计", capacityBody: "统计结果超出显示容量，请求未返回任何部分数据。", previousResult: "之前的结果", loadMore: "加载更多活动记录",
  ...
  'zh-TW': {
    staleTitle: "統計已更新", staleBody: "目前顯示先前的完整結果。請重新整理後繼續瀏覽。", loadFailed: "無法載入使用統計", capacityBody: "統計結果超出顯示容量，請求未傳回任何部分資料。", previousResult: "先前的結果", loadMore: "載入更多活動記錄",
  ...
  en: {
    staleTitle: 'Usage has changed', staleBody: 'The previous complete result is still shown. Refresh to continue browsing.', loadFailed: 'Unable to load Usage', capacityBody: 'This complete result exceeds the display capacity. No partial result was loaded.', previousResult: 'Previous result', loadMore: 'Load more activity',
